...
export class HomePage {
  protected readonly landingFeatures: LandingFeature[] = [
    {
      title: 'Agendamento online',
      description: 'Cliente escolhe o servico, informa o veiculo e recebe confirmacao sem depender de ligacao.',
      colorClass: 'bg-mint'
    },
    {
      title: 'Acompanhamento do servico',
      description: 'Atualizacoes claras sobre entrada, diagnostico, execucao, pagamento e retirada.',
      colorClass: 'bg-sky-500'
    },
    {
      title: 'Historico do cliente',
      description: 'Dados do veiculo, ultimas visitas, avaliacoes e servicos feitos em um unico lugar.',
      colorClass: 'bg-fuel'
    }
  ];

  protected readonly serviceSteps: ServiceStep[] = [
    { label: 'Agendado', detail: 'Hoje, 14:00', active: true },
    { label: 'Em diagnostico', detail: 'Tecnico Rafael', active: true },
    { label: 'Orcamento', detail: 'Aguardando aceite' },
    { label: 'Entrega', detail: 'Previsao 17:30' }
  ];
